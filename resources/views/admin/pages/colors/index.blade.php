                    ...
                    <div class="card-body">
                        <form action="{{route('adminpanel.color.store')}}" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') in-valid @enderror" value="{{old('name')}}">
                                @error('name')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="color" name="code" id="code" class="form-control @error('code') in-valid @enderror" value="{{old('color')}}">
                                @error('code')
                                    <span class="invalid-feedback">
                                        <strong>{{$message}}</strong>
                                    </span>
