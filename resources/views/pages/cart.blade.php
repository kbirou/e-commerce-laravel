        ...
        <section class="pop-up">
            <div class="pop-up-box">
                ...
                <div class="pop-up-actions">
                    <a href="{{route('cart')}} " class="btn btn-outlined">Continue Shoping</a>
                    <a href="{{route('cart')}}" class="btn btn-primary">Go to Chekout</a>
                </div>
            </div>
        </section>
    @endif
    <main class="cart-page">
        <div class="container">
            ...
            <div class="cart-actions">
                <a href="" class="btn btn-primary">Go to chekout</a>
            </div>
        </div>
    </main>
@endsection